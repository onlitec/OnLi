...
This is a form to test if a CSRF exists into a OnLi page.<br>
<br>
...
<br>
<?php
	$urltosendrequest = "http://127.0.0.1/onli/htdocs/user/group/card.php";
...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
	<form action="http://localhostgit/onli_dev/htdocs/user/logout.php">
