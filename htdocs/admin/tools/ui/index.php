	...
	<div class="doc-content-wrapper">
		...
		<div class="doclinks-section">
			...
			<div class="doclinks-wrapper" style="justify-content: space-between;">
				...
				<a class="doc-link size-default" href="https://www.onli.fr/forum/" target="_blank">
					<div class="link-title"><span class="fas fa-external-link-alt paddingright"></span> OnLi community</div>
					<div class="link-content">Meet and chat with the OnLi community on the dedicated forum</div>
				</a>
			</div>
		</div>
		...
		// Remove BackToOnLi and Documentation Home from menu
		// Remove Resources from menu (Set manually above)
		unset($indexMenu['BackToOnLi']);
