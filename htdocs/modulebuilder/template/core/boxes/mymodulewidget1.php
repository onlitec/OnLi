 ...
 *
 * Warning: for the box to be detected correctly by onli,
...
class mymodulewidget1 extends ModeleBoxes
{
	...
	/**
	 * Load data into info_box_contents array to show array later. Called by OnLi before displaying the box.
	 *
