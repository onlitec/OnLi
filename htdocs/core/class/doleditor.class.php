...
class DolEditor
{
	 ...
	 *  @param 	string				$toolbarname	       		 	Name of the toolbar set to use ('onli_details[_encoded]'=the less featured, 'onli_notes[_encoded]' for notes content, 'onli_mailings[_encoded]' for emailing content, 'onli_readonly').
