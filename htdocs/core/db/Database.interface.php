...
/**
 *    Class to manage OnLi database access for an SQL database
 */
interface Database
{
	/**
	 ...
	 *
	 * @param    string $onli_main_db_host 	Server IP
	 * @param    string $onli_main_db_user 	Username to create
	 * @param    string $onli_main_db_pass 	User password to create
