 ...
 */
class modOpenSurvey extends OnLiModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Use here a free id (See in Home -> System information -> OnLi for list of used module id).
		$this->numero = 55000;
		...
		$this->need_onli_version = array(3, 4, 0); // Minimum version of OnLi required by module
