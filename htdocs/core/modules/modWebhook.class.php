 ...
 */
class modWebhook extends OnLiModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 68305; // TODO Go on page https://wiki.onli.org/index.php/List_of_modules_id to reserve an id number for your module
		...
		$this->descriptionlong = "Interface to catch onli triggers and send data of the event to an external URL";
