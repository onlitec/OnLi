 ...
 */
class modAsset extends OnLiModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 51000; // TODO Go on page https://wiki.onli.org/index.php/List_of_modules_id to reserve id number for your module
	 ...
	 *  The init function adds constants, boxes, permissions and menus (defined in constructor) into OnLi database.
