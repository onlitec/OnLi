 ...
 */
class modEmailCollector extends OnLiModules
{
	/**
	...
	public function init($options = '')
	{
		...
		if ($tmpresql) {
			if ($this->db->num_rows($tmpresql) == 0) {
				$descriptionB1 = $langs->trans('EmailCollectorExampleToCollectOnLiAnswersDesc');
				$label = $langs->trans('EmailCollectorExampleToCollectOnLiAnswers');
