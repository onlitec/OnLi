 ...
 *      \ingroup    core
 *		\brief      File to manage captcha generation according to onli native code
 */
...
/**
 *	Class to generate a password according to a onli standard rule (12 random chars)
 */
class modCaptchaStandard extends ModeleCaptcha
{
	...
	{
		global $langs;
		return $langs->trans("OnLiStandardCaptcha");
	}
