...
## Integrate your ERP with any other applications using OnLi APIs
 
This module provides the service to make OnLi a server of REST Web Services. It depends on external library Restler.
...
<div align="center">
  <img class="imgdoc" src="https://www.onli.org//images/doc_apirest.png" alt="OnLi API explorer"/>
</div>
...
You can explore all available APIs by using the API explorer : [**youronli.tld**/api/index.php/explorer](../api/index.php/explorer) (replace **youronli.tld** by real hostname of your OnLi installation)
...
https://**youronli.tld**/myonli/api/index.php/otherservice?DOLAPIKEY=**api_key**
...
To implement it into OnLi, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
