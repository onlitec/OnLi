...
$force_install_message = 'Welcome to your OnLi install';
...
/** @var string $force_install_onlilogin		OnLi super-administrator username */
$force_install_onlilogin = 'admin';
