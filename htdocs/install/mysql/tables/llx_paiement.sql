...
(
  ...
  amount           double(24,8) DEFAULT 0,				-- amount paid in OnLi currency
  ...
  note             text,
  ext_payment_id   varchar(255),						-- external id of payment (for example Stripe payment intent ID 'pi_...:cus_...@pk_live_...')
