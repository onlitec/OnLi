#!/bin/sh
#------------------------------------------------------
# Script to remove setup of a OnLi installation.
...
$DIALOG --title "Remove OnLi install" --clear \
...
echo "OnLi setup has been removed (need to be installed again. database not dropped)."
echo
