...
OnLi in the current workspace with Docker. This docker image is intended for
**development usage**. For production usage you should consider other
contributor reference like https://hub.docker.com/r/onli/onli.
...
This will run 4 containers Docker : OnLi, MariaDB, PhpMyAdmin and MailDev.
In the case of PostgreSQL, only OnLi, MailDev and the PostgreSQL database
will be running.

The URL to go to the OnLi is :
...
In OnLi configuration Email let PHP mail function, To see all mail send by
OnLi go to maildev
...
This will add your module at runtime inside the onli custom plugins and it
