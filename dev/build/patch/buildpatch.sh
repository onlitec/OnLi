...
# changes on files in its OnLi tree.
# The output patch file can then be submitted on OnLi dev mailing-list,
...
then
	...
	echo Example: buildpatch.sh  /mydirA/OnLiold  /mydirB/OnLinew
else
