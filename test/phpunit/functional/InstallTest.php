...
{
	protected static $url = 'https://dev.onli.org';
	protected static $db_name = 'onli_test';
	protected static $db_host = 'localhost';
	protected static $db_admin_user = 'root';
	protected static $db_admin_pass = '';
	protected static $db_user = 'onli';
	protected static $db_pass = 'onli';
	...
	{
		$this->assertStringContainsString('OnLi', $this->title());
	}
	...
	public function testForm()
	{
		...
		$this->assertEquals('onli', $this->byId('db_name')->value());
